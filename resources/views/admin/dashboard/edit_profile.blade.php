...
@section('content')
    ...
    <form method="post" action="{{ route('Store_Profile') }}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/noimg.png') }}" height="80" width="80">
            </div>
        </div>
        <!-- end row -->
