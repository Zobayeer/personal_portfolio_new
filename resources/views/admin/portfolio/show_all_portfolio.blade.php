...
<thead>
    ...
    <tbody>
        ...
        <td>{{str_limit($item->portfolio_desc, $limit = 40, $end = '...')}}</td>
        ...
        <td>
            ...
            <a href="{{ route('delete.item',$item->id) }}" class="btn btn-danger sm" title="delete photo" id="delete"><i class="fa fa-trash"></i></a>
        </td>
      </tr>
      @endforeach
